...
$bleu = $brevity_penalty * exp((my_log( $bleu[1] ) +
				...
				my_log( $bleu[3] ) +
				my_log( $bleu[4] ) ) / 4) ;
$bleu1 = $brevity_penalty *$bleu[1];
$bleu2 = $brevity_penalty *$bleu[2];
$bleu3 = $brevity_penalty *$bleu[3];
$bleu4 = $brevity_penalty *$bleu[4];


printf "BLEU = %.4f, %.4f, %.4f, %.4f, %.4f (BP=%.3f, ratio=%.3f, hyp_len=%d, ref_len=%d)\n",
    100*$bleu,
    100*$bleu1, #100*$bleu[1],
    100*$bleu2, #100*$bleu[2],
    100*$bleu3, #100*$bleu[3],
    100*$bleu4, #100*$bleu[4],
    $brevity_penalty,
