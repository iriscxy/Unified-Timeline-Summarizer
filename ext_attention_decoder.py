...
def ext_attention_decoder(decoder_inputs, initial_state, encoder_states, enc_padding_mask, cell,
    ...
    with variable_scope.variable_scope("attention_decoder") as scope:
        ...
        for i, inp in enumerate(decoder_inputs):
            ...
            input_size = inp.get_shape().with_rank(3)[-1]
            inp = tf.reshape(inp, [FLAGS.batch_size, input_size])
